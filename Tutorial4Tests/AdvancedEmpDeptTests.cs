    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            ...
            .Join(grades, 
                x => true,
                x => true,
                (empDept, grade) => new { empDept, grade })
            .Where(r => r.empDept.emp.Sal >= r.grade.Losal && r.empDept.emp.Sal <= r.grade.Hisal)
            .Select(r => new { r.empDept.emp.EName, r.empDept.dept.DName, r.grade.Grade });
