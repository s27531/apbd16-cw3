...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        List<Emp> result = emps.Where(emp => emp.Job == "SALESMAN")
            .ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, 
                x => true,
                x => true,
                (emp, grade) => new { emp.EName, grade.Grade, emp.Sal, grade.Losal, grade.Hisal }
            )
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps
                ...
                .Select(r => new { DeptNo = r.Key, AvgSal = r.Average(emp => emp.Sal)}); 
